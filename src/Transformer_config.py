...
class EasyTransformerConfig:
    ...
    Args:
        ...
        d_in (int): The dimensionality of the input vectors at each step.
        ...
        d_vocab_out (int, *optional*): The size of the output vocabulary. If not set, will be equal to d_vocab. Mainly useful for algorithmic tasks where the input and output vocabularies may be different (IN CASE OF BINARY PREDICTION AT EACH STEP d_vocab_out=2)
