...
log_file_path = os.path.join(logs_folder, "train_DL_II.log")  # Full path for the log file
logging.basicConfig(
...
def train(
    ...
    for epoch in tqdm(range(1, config.num_epochs + 1)):
        ...
        for step, batch in tqdm(enumerate(dataloader)):
            ...
            logits = model(inputs, return_type='logits') # Return logits for CE loss with sign prediction
            ...
            if (
                ...
                logging.info(f"Loss at step {step} = {loss.item()}")
            ...
            if (
                ...
                torch.save(model.state_dict(), f"{config.save_dir}/model_{step}_II.pt")
...
if __name__ == "__main__":
    ...
    # Final Save
    # model_path = "../trained_models_DL/trained_GTP2.pth"
    ...
    # Final Save
    model_path = "../trained_models_DL/trained_GTP2_II.pth"
